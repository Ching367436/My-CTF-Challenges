...
CAPTCHA_NOISE_FUNCTIONS = ('captcha.helpers.noise_arcs', 'captcha.helpers.noise_dots', 'captcha.helpers.noise_arcs', 'captcha.helpers.noise_dots', 'captcha.helpers.noise_null')

CAPTCHA_MATH_CHALLENGE_OPERATOR = 'x'

CAPTCHA_FOREGROUND_COLOR = '#ffcccc'
